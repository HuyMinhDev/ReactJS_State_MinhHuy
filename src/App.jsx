      ...
      <div className="container py-4">
        <div className="row justify-content-center align-items-start">
          ...
          <div className="col-md-4 position-relative text-center">
            <img
              src="/public/assets/img/model.jpg"
              alt="model"
              className="img-fluid"
